...
class WP_Contributions_Gists_Widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array(
			'classname'   => 'contributions_gists',
			'description' => __( 'Add a list of your contributions as gists as a sidebar widget.', 'wp-contributions' )
		);

		parent::__construct( false, __( 'WP Contributions: GitHub Gists', 'wp-contributions' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		// Widget content
		$theme_args = array(
			'items' => array_slice( WP_Contributions_Github_Api::get_gists( $username ), 0, $count )
		);

		// Include template
		WP_Contributions::load_template( 'github-gists-widget.php', $theme_args );
